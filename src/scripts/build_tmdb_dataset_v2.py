...
ts_code = """export interface Review {
  id: string;
  user: string;
  avatar: string;
  rating: number;
...
export const MOVIES_DATABASE: Movie[] = """ + json.dumps(processed_movies, indent=2) + ";\n"

out_file = r"C:\Users\jaswa\.gemini\antigravity\scratch\cinemind-ai\src\data\movies.ts"
with open(out_file, "w", encoding="utf-8") as f:
    f.write(ts_code)

print("Overwrote src/data/movies.ts with TMDB 5000 official poster data successfully!")
